...
Datapath = fullfile(Rootpath, 'code\result', [genotype, '_genotype']);

zImgNorm = importdata([Rootpath, filesep, 'test_case', filesep,'CEST.mat']);
M0image = importdata([Rootpath, filesep, 'test_case',filesep,'M0_Image.mat']);
mask = importdata([Rootpath, filesep, 'test_case\Mask',filesep,'Mask_Brain.mat']);
mask_tumor_pred = importdata([Rootpath, filesep,'code\result\Segmentation', filesep, 'pred_mask_post_processing.mat']);
